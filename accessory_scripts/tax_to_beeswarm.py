...
parser.add_argument("-ms","--markersize",help="Pass the marker sizer length (dots on beeswarm plot)",default=6,type=int)
parser.add_argument("-gt","--groupbytax",help="Group EVEs families/orders by the number of elements, default = 5",default=5,type=int)
parser.add_argument("-gp","--groupbyprot",help="Group EVEs proteins categories by the number of proteins, default = 20 ",default=20,type=int)
...
beeswarn_plot =sns.swarmplot(x='Length',y='Super-Kingdom', hue=plot_mode, data=df, size=mark_size)
...
beeswarn_plot.legend(loc='upper right', ncol=2, fancybox=True, prop={'size': 12},title='EVEs '+plot_mode, title_fontsize=14)
...
plt.clf()
###############################>SENSE-BEESWARNPLOT<###############################
beeswarn_plot =sns.swarmplot(x='Sense',y='Length', hue=plot_mode, data=df, size=mark_size)
...
beeswarn_plot.legend(loc='upper center', ncol=2, fancybox=True, prop={'size': 12},title='EVEs '+plot_mode, title_fontsize=14)
...
beeswarn_plot =sns.swarmplot(x='Length',y='ProteinProducts', hue=plot_mode, data=df, size=mark_size)
#sns.despine(fig=None, top=True, right=True, left=False, bottom=False, offset=None, trim=False)
