...
parser = argparse.ArgumentParser(
    description="Create stacked barplot file for each assembly present in a concatenated taxonomy file"
)
parser.add_argument(
    "-in",
    "--input",
    help="Concatenated file from more than 1 .tax file generated by PEVEI.py",
    required=True,
)
parser.add_argument(
    "-md",
...
parser.add_argument(
    "-gt",
    "--groupbytax",
    help="Pass treshold number do group taxons, default = 5",
    default=5,
    type=int,
)
